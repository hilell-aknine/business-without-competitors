...
(function () {
  ...
  const TOPIC_KEYWORDS = {
    ...
    'שיווק':    ['שיווק', 'קמפיין', 'פרסום', 'תוכן', 'אורגני'],
    'מנהיגות':  ['מנהיגות', 'מנהיג', 'הובלה'],
    'מוצר':     ['מוצר', 'הצעה', 'מוצרים'],
    'המרה':     ['המרה', 'סגירה', 'מכירה', 'שיחת מכירה', 'סגירת'],
    'משוב':     ['פידבק', 'משוב', 'ביקורת'],
    'מותג':     ['מותג', 'מיתוג', 'זהות', 'ברנד'],
    'חדשנות':   ['חדשנות', 'אינוואציה', 'יצירתיות'],
    'אסטרטגיה': ['אסטרטגיה', 'תכנון', 'תוכנית'],
    'קהל':      ['קהל', 'אווטאר', 'לקוח', 'פרסונה']
  };
